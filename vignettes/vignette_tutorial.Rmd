...
The first step to identify loci particularly associated with environmental variation is to regress the genetic matrix against the environmental predictors using RDA model.
...
The genomic offset predictions are negatively correlated with fitness in the population
...
The \code{adaptive_groups} function allows the user to find groups of covarying individuals or populations based on their scores in the RDA space and a hkmean clustering procedure.
...
\code{adaptive_groups} accommodates discrete populations as above, or stack of rasters as below.
...
The function was initially designed to identify conservation units or seed zones across the range of a species.

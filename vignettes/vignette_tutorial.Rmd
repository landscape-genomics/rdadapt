...
```{r, message=FALSE, warning=FALSE, results='hide', eval=TRUE, fig.align='center', fig.height = 4, fig.width= 7, echo=FALSE}
...
```{r, message=FALSE, warning=FALSE, results='hide', eval=TRUE, fig.align='center', fig.width=7, echo=FALSE}

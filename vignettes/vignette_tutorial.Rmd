...
Here the adaptive landscape is very continuous so it looks more like discretizing a continuous distribution, adaptive indices or genomic offset are probably more appropriate. However, this functionality can become handy for management or conservation purposes, for example to identify conservation units or seed zones across the range of a species.
